...
class TipKeyword(UserNodeKeyword):
    ...
    def dump_comments(self, comments):
        ...
        for comment in comments:
            ...
            template = 'export_comment_whistleblower' if (comment['type'] == 'whistleblower') else 'export_comment_recipient'
            ret += indent_text('-' * 40) + '\n'
...
class ExportMessageKeyword(TipKeyword):
    ...
    def Author(self):
        return 'Recipient' if self.data['comment']['type'] == 'receiver' else 'Whistleblower'
